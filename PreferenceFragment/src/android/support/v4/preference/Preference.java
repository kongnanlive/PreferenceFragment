...
import android.support.v4.preference.util.CharSequences;
...
//            editor.putStringSet(mKey, values);
            MethodsCompat.putStringSet(editor, mKey, values);
            tryCommit(editor);
            return true;
        }
        return false;
...
//        return mPreferenceManager.getSharedPreferences().getStringSet(mKey, defaultReturnValue);
        return MethodsCompat.getValue(mPreferenceManager.getSharedPreferences(), mKey, defaultReturnValue);
    }
