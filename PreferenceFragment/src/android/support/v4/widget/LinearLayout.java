...
import android.support.v4.preference.util.MethodsCompat;
 ...
 *
 * @attr ref android.R.styleable#LinearLayout_android_baselineAligned
 * @attr ref android.R.styleable#LinearLayout_android_baselineAlignedChildIndex
 * @attr ref android.R.styleable#LinearLayout_android_gravity
 * @attr ref android.R.styleable#LinearLayout_android_measureWithLargestChild
 * @attr ref android.R.styleable#LinearLayout_android_orientation
 * @attr ref android.R.styleable#LinearLayout_android_weightSum
 */
public class LinearLayout extends ViewGroup {
    ...
    public LinearLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        boolean baselineAligned = a.getBoolean(R.styleable.LinearLayout_android_baselineAligned, true);
        if (!baselineAligned) {
        ...
        mBaselineAlignedChildIndex =
                a.getInt(R.styleable.LinearLayout_android_baselineAlignedChildIndex, -1);

        mUseLargestChild = a.getBoolean(R.styleable.LinearLayout_android_measureWithLargestChild, false);

        setDividerDrawable(a.getDrawable(R.styleable.LinearLayout_android_divider));
        mShowDividers = a.getInt(R.styleable.LinearLayout_android_showDividers, SHOW_DIVIDER_NONE);
        mDividerPadding = a.getDimensionPixelSize(R.styleable.LinearLayout_android_dividerPadding, 0);
     ...
     *
     * @attr ref android.R.styleable#LinearLayout_android_divider
     */
    ...
    void measureVertical(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < count; ++i) {
            ...
            int measuredState = MethodsCompat.getMeasuredState(child);
            childState = combineMeasuredStates2(childState, measuredState);
        ...
        int heightSizeAndState = resolveSizeAndState2(heightSize, heightMeasureSpec, 0);
        ...
        setMeasuredDimension(resolveSizeAndState2(maxWidth, widthMeasureSpec, childState),
                heightSizeAndState);
    ...
    public int combineMeasuredStates2(int curState, int newState) {
    ...
    void measureHorizontal(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < count; ++i) {
            ...
            final int measuredState = MethodsCompat.getMeasuredState(child);
            childState = combineMeasuredStates2(childState, measuredState);
        ...
        int widthSizeAndState = resolveSizeAndState2(widthSize, widthMeasureSpec, 0);
...
//                    childState = combineMeasuredStates2(childState,
//                            child.getMeasuredState() & MEASURED_STATE_MASK);
                    int measuredState = MethodsCompat.getMeasuredState(child);
                    childState = combineMeasuredStates2(childState,
                    		measuredState & MEASURED_STATE_MASK);
                }
        ...
        setMeasuredDimension(widthSizeAndState | (childState&MEASURED_STATE_MASK),
                resolveSizeAndState2(maxHeight, heightMeasureSpec,
     ...
     * 
     * @attr ref android.R.styleable#LinearLayout_android_Layout_layout_weight
     * @attr ref android.R.styleable#LinearLayout_android_Layout_layout_gravity
     */
