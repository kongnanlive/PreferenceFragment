...
package android.support.v4.app.support;
...
public class DialogFragment extends Fragment implements DialogInterface.OnCancelListener,
     ...
     * any frame at all; the view hierarchy returned by {@link #onCreateView} is entirely
     ...
     * 
     * @param style
     *            Selects a standard style: may be {@link #STYLE_NORMAL}, {@link #STYLE_NO_TITLE},
     ...
     * fragment to it with the given tag, and committing it. This does <em>not</em> add the
     * transaction to the back stack. When the fragment
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Field f;
        try {
            f = getClass().getSuperclass().getDeclaredField("mContainerId");
            f.setAccessible(true);
            mContainerId = (Integer) f.get(this);
