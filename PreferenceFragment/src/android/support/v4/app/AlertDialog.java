 ...
 * WindowManager.LayoutParams.FLAG_ALT_FOCUSABLE_IM} for you based on whether any views in the
 * dialog return true from {@link View#onCheckIsTextEditor()
 * View.onCheckIsTextEditor()}. Generally you want this set for a Dialog without text editors, so
 * that it will be placed on top of the current input method UI. You can modify this behavior by
 * forcing the flag to your desired mode after calling {@link #onCreate}. <div
...
public class AlertDialog extends Dialog implements DialogInterface {
     ...
     * constants {@link #THEME_TRADITIONAL}, {@link #THEME_HOLO_DARK}, or {@link #THEME_HOLO_LIGHT}.
     */
     ...
     *            {@link DialogInterface#BUTTON_POSITIVE}, {@link DialogInterface#BUTTON_NEGATIVE},
    ...
    public static class Builder {
         ...
         * here supply either the name of an attribute in the theme from which
         * to get the dialog's style (such as {@link android.R.attr#alertDialogTheme} or one of the
         * constants {@link AlertDialog#THEME_TRADITIONAL AlertDialog.THEME_TRADITIONAL},
        ...
        public Builder(Context context, int theme) {
            P = new AlertController.AlertParams(new ContextThemeWrapper(context,
                    resolveDialogTheme(context, theme)));
            mTheme = theme;
        }
         ...
         *            items are checked. If non null it must be exactly the same length as the array
         *            of
         *            items.
         * @param listener
