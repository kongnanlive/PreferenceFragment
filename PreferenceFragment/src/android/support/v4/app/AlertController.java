...
//        }
    ...
    private void setBackground(LinearLayout topPanel, LinearLayout contentPanel,
        ...
        int fullDark = a.getResourceId(
                R.styleable.AlertDialog_fullDark, R.drawable.dialog_full_holo_light);
        int topDark = a.getResourceId(
                R.styleable.AlertDialog_topDark, R.drawable.dialog_top_holo_light);
        int centerDark = a.getResourceId(
                R.styleable.AlertDialog_centerDark, R.drawable.dialog_middle_holo_light);
        int bottomDark = a.getResourceId(
                R.styleable.AlertDialog_bottomDark, R.drawable.dialog_bottom_holo_light);
        int fullBright = a.getResourceId(
                R.styleable.AlertDialog_fullBright, R.drawable.dialog_full_holo_light);
        int topBright = a.getResourceId(
                R.styleable.AlertDialog_topBright, R.drawable.dialog_top_holo_light);
        int centerBright = a.getResourceId(
                R.styleable.AlertDialog_centerBright, R.drawable.dialog_middle_holo_light);
        int bottomBright = a.getResourceId(
                R.styleable.AlertDialog_bottomBright, R.drawable.dialog_bottom_holo_light);
        int bottomMedium = a.getResourceId(
                R.styleable.AlertDialog_bottomMedium, R.drawable.dialog_bottom_holo_light);
