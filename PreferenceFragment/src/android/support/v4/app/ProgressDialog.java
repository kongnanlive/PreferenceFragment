...
public class ProgressDialog extends AlertDialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TypedArray a = mContext.obtainStyledAttributes(null, R.styleable.AlertDialog,
        ...
        if (mProgressStyle == STYLE_HORIZONTAL) {
            ...
            View view = inflater.inflate(a.getResourceId(R.styleable.AlertDialog_progressLayout,
