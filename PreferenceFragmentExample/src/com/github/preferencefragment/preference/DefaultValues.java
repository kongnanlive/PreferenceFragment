...
package com.github.preferencefragment.preference;
 ...
 * values.
 * <p>
 * In order for the default values to be populated into the {@link SharedPreferences} (from the
 * preferences XML file), the client must call
 * {@link PreferenceManager#setDefaultValues(android.content.Context, int, boolean)}.
 * <p>
 * This should be called early, typically when the application is first created. An easy way to do
 * this is to have a common function for retrieving the SharedPreferences that takes care of calling
 * it.
 */
