...
package com.github.preferencefragment.app;
...
import android.support.v4.app.ProgressDialog;
...
import com.github.preferencefragment.R;

/**
 * Example of how to use an {@link android.app.AlertDialog}. <h3>AlertDialogSamples</h3>
 * <p>
 * This demonstrates the different ways the AlertDialog can be used.
 * </p>
 * <h4>Demo</h4> App/Dialog/Alert Dialog <h4>Source files</h4>
...
public class AlertDialogSamples extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*
         * Display a text message with yes/no buttons and handle each message as well as the cancel
         * action
         */
        ...
        /*
         * Display a long text message with yes/no buttons and handle each message as well as the
         * cancel action
         */
        Button twoButtons2Title = (Button) findViewById(R.id.two_buttons2);
        twoButtons2Title.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                showDialog1(DIALOG_YES_NO_LONG_MESSAGE);
            }
        });

        /*
         * Display an ultra long text message with yes/no buttons and handle each message as well as
         * the cancel action
         */
        ...
        twoButtons2UltraTitle.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                showDialog1(DIALOG_YES_NO_ULTRA_LONG_MESSAGE);
            }
        });
        ...
        radioButton.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                showDialog1(DIALOG_SINGLE_CHOICE);
            }
        });
        ...
        checkBox.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                showDialog1(DIALOG_MULTIPLE_CHOICE);
            }
        });
        ...
        checkBox2.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                showDialog1(DIALOG_MULTIPLE_CHOICE_CURSOR);
            }
        });
        ...
        twoButtonsOldSchoolTitle.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                showDialog1(DIALOG_YES_NO_OLD_SCHOOL_MESSAGE);
            }
        });
        ...
        twoButtonsHoloLightTitle.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                showDialog1(DIALOG_YES_NO_HOLO_LIGHT_MESSAGE);
            }
        });
    ...
    public final void showDialog1(int id) {
        showDialog1(id, null);
    }

    public final boolean showDialog1(int id, Bundle args) {

        onCreateDialog1(id).show();
